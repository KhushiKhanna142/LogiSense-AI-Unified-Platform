    ...
    return (
        <div className='bg-slate-900 rounded-xl p-4'>
            ...
            <div className='flex items-center gap-3 mb-3'>
                ...
                <span className='text-slate-400 text-sm'>Warehouse Heatmap</span>
                {congestedCount > 0 && (
            ...
            {congestions.map((c, i) => (
                <div key={i} className='mt-2 bg-orange-900/40 border border-orange-500/30
                                  rounded-lg p-2 text-xs text-orange-300'>
